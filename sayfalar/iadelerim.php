...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hoşgeldiniz
        <small>İade İşlemleri</small>
      </h1>
    </section>
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">İade Kitaplar Ekranı</h3>
					...
					<div class="col-lg-12">
						<div class="col-lg-12">
							<div class="row">
								...
								<h3>İade Ettiklerim Kitaplar</h3>
								<table class="datatable">
								  <thead>
								  <tr >
								  <?php 
									  gridBaslikOlustur(array('S.No','KITAP ADI','YAZAR ADI','YAYINEVİ','KATEGORI','TARİH'));								  
									  ?>
									</tr>
								  </thead>
								  <tbody>
									...
									$sql="SELECT islemler.id as id, islemler.uye_id as uyeid, uyeler.UYE_USERNAME kulladi, islemler.kitap_id kitapid, yazarlar.YAZAR_ADI as yazaradi, kitaplar.kitap_adi kitapadi, kategoriler.isim as kategori, yayinevleri.YAYINEVI_UNVAN as yayinevi, islemler.tarih as tarihi,  islemler.durumu as durum FROM islemler
											...
											LEFT JOIN kategoriler ON kitaplar.kitap_kategoriid = kategoriler.id
												WHERE UYELER.UYE_USERNAME='".$kull."' and islemler.durumu='ODUNC' and kitaplar.kitap_durumu='RAFTA' ORDER BY KITAP_ADI asc";			
										$smt = $pdo->prepare($sql);
										$smt->execute();
										$data = $smt->fetchAll();
										$sirano=0;
