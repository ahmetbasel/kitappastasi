...
if ($job != ''){
 ...
 k.ID AS ID, k.KITAP_ADI AS KITAP_ADI, yazarlar.YAZAR_ADI AS YAZAR_ADI, raflar.seri AS RAF_SERI, 
	...
	k.KITAP_GIRISTARIHI AS GIRISTARIHI, k.KITAP_BARKOD AS BARKOD, k.OLUSTURAN AS OLUSTURAN, k.KITAP_EDINIM AS EDINIM, uyeler.UYE_USERNAME as BAGISCI  FROM KITAPLAR k
