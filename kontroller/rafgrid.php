...
if ($job != ''){
  ...
  if ($job == 'get_companies'){
    // Get companies
    $sql = "SELECT (@row_number:=@row_number + 1) AS row_num, id, seri,kapasite, OLUSTURAN FROM RAFLAR, (SELECT @row_number:=0) AS t ORDER BY ID desc";
